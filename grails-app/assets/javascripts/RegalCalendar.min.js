...
function adjust(n){var t=$(window).width();t=t>n.parent().width()?n.parent().width():t-100,n.width(t).css({"margin-left":"20px","margin-right":"20px"});var e=t*.0022,i=t*.0009+.4,s=t*.0009+.4,f=t*.0225+1,r=t*.015,u=(18+t*.01)*-1,o=20+t*.013;n.find("span.ui-datepicker-month").css("font-size",e+"em"),n.find("table").css({"font-size":i+"em","line-height":i+"em"}),n.find(".ui-datepicker td span, .ui-datepicker td a").css("width",f+"px"),n.find("table tr td").css("width",r+"%"),n.find("div.event").css({"margin-top":u+"px","margin-left":o+"px"})}function setEvents(n,t,i){n.each(function(){var e=$(this).attr("data-customText")==undefined?"":'<span class="rg-custom">'+$(this).attr("data-customText")+"</span>",n=$(this).attr("data-date").split("/"),h=$(this).attr("data-time"),o=$(this).attr("data-icon")==undefined?"":'<div class="event '+$(this).attr("data-icon")+'" data-txt="'+$(this).text()+'" data-date="'+$(this).attr("data-date")+'" data-time="'+$(this).attr("data-time")+'" data-title="'+$(this).attr("data-title")+'" data-location="'+$(this).attr("data-location")+'"></div>'+e,s=$(this).attr("data-preview")==undefined?"":'<div class="pv">'+$(this).attr("data-preview")+"</div>",r,i,u,f;n[1]=(parseInt(n[1])-1).toString(),r=t.find("td[data-month='"+n[1]+"'][data-year='"+n[2]+"']:containsNumber("+n[0]+")"),r.append(s+o),i=r.find("div.event"),u=i.size(),u>1&&(f=n,$('span.event[data-date="'+$(this).attr("data-date")+'"]').addClass("multiple"),i.each(function(){$(this).addClass("multiple").html("<span>"+$(this).attr("data-title")+"</span>")}))});var r=$("div.regalcalendar td").has("div.multiple").not(":has(.multiple-container)");r.each(function(){$(this).append('<div class="eGroup '+i+'"></div><div class="multiple-container"></div>');var t=$(this).find("div.multiple-container"),n=$(this).find(".multiple");n.appendTo(t)})}function setTooltip(n,t,i,r,u,f,e,o,s,h,c){n.not(".multiple").each(function(){var y=$(this).attr("data-title"),w=$(this).attr("data-location"),n=$(this).attr("data-date").split("/"),p=$(this).attr("data-time").split(":"),it=$(this).attr("data-icon"),nt=$(this).html(),a="",g,b,tt=c==""?"":"mapLink",d,k;if(h=="hrs")g="hrs",b=$(this).attr("data-time");else{var l=p[0],v=p[1],g=l>=12?"pm":"am";l=l%12,l=l?l:12,v=v<10?"0"+v:v,b=l+":"+v}a=o=="top"?"bottom":o=="bottom"?"top":o=="left"?"right":"left",d=e?'<a href="https://twitter.com/intent/tweet?text=Attend%20to%20'+y+"%20&screen_name="+e+'" class="twitter-mention-button" data-lang="en" data-related="'+e+'">Attend to '+y+'</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"><\/script>':"",n[1]=(parseInt(n[1])-1).toString(),k=t.find("td[data-month='"+n[1]+"'][data-year='"+n[2]+"'] a:containsNumber("+n[0]+")").data({title:y,location:w}),k.qtip({content:{text:d+'<div class="tooltip-body">'+nt+'</div><div class="tooltip-hours">'+b+" "+g+'</div><div class="tooltip-location event School '+tt+'">'+c+'</div><div class="count"><div></div></div>',title:{text:y,button:"Close"}},position:{my:a+" center",at:o+" center"},show:{event:s},hide:{fixed:!0,delay:2e3},style:{classes:"draggable-tooltip qtip-shadow qtip-"+f},events:{show:function(t){$(t.currentTarget).hide().fadeIn(1e3),$(t.currentTarget).removeClass(r).addClass(u+" "+i+" animate");var e=new Date(n[2],n[1],n[0],p[0],p[1]);$(".count div").countdown({until:e,layout:"{dn} {dl} {hnn}{sep}{mnn}{sep}{snn}"}),$(t.currentTarget).find(".tooltip-location").qtip({content:{text:'<div class="map_mylocation"></div>',title:{text:w,button:"Close"}},position:{my:"bottom center",at:"up center"},hide:!1,style:{classes:"draggable-tooltip qtip-shadow qtip-"+f},events:{show:function(n){var t=$(n.currentTarget).find(".map_mylocation");setTimeout(function(){$(n.currentTarget).geocomplete({map:t,location:w})},0)},render:function(n,t){$(this).draggable({containment:"window",handle:t.elements.titlebar})}}})},hide:function(n){$(n.currentTarget).show(),$(n.currentTarget).removeClass(i).addClass(r).fadeOut(1e3)},render:function(n,t){$(this).draggable({containment:"window",handle:t.elements.titlebar})}}})}),t.find(".multiple-container").each(function(){var n=$(this),a=$(this).parent("td"),l=n.find("div.multiple").eq(0),t=l.attr("data-date");a.qtip({content:{text:'<div class="tooltip-body">'+n.html()+"</div>",title:{text:"Events on "+t,button:"Close"}},position:{my:"left center",at:"right center"},show:{event:s},hide:{fixed:!0,delay:2e3},style:{classes:"draggable-tooltip qtip-shadow qtip-"+f},events:{show:function(t){$(t.currentTarget).hide().fadeIn(1e3),$(t.currentTarget).removeClass(r).addClass(u+" "+i+" animate");var l=$(t.currentTarget).find(".multiple");l.each(function(){var y=$(this).attr("data-title"),b=$(this).attr("data-location"),t=$(this).attr("data-date").split("/"),p=$(this).attr("data-time").split(":"),it=$(this).attr("data-icon"),nt=$(this).attr("data-txt"),a="",d,w,tt=c==""?"":"mapLink",k,g;if(h=="hrs")d="hrs",w=$(this).attr("data-time");else{var l=p[0],v=p[1],d=l>=12?"pm":"am";l=l%12,l=l?l:12,v=v<10?"0"+v:v,w=l+":"+v}a=o=="top"?"bottom":o=="bottom"?"top":o=="left"?"right":"left",k=e?'<a href="https://twitter.com/intent/tweet?text=Attend%20to%20'+y+"%20&screen_name="+e+'" class="twitter-mention-button" data-lang="en" data-related="'+e+'">Attend to '+y+'</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"><\/script>':"",t[1]=(parseInt(t[1])-1).toString(),g=n.find("td[data-month='"+t[1]+"'][data-year='"+t[2]+"'] a:containsNumber("+t[0]+")").data({title:y,location:b}),$(this).qtip({content:{text:k+'<div class="tooltip-body">'+nt+'</div><div class="tooltip-hours">'+w+" "+d+'</div><div class="tooltip-location event School '+tt+'">'+c+'</div><div class="count"><div></div></div>',title:{text:y,button:"Close"}},position:{my:a+" center",at:o+" center"},show:{event:s},hide:{fixed:!0,delay:2e3},style:{classes:"draggable-tooltip qtip-shadow qtip-"+f},events:{show:function(n){$(n.currentTarget).hide().fadeIn(1e3),$(n.currentTarget).removeClass(r).addClass(u+" "+i+" animate");var e=new Date(t[2],t[1],t[0],p[0],p[1]);$(".count div").countdown({until:e,layout:"{dn} {dl} {hnn}{sep}{mnn}{sep}{snn}"}),$(n.currentTarget).find(".tooltip-location").qtip({content:{text:'<div class="map_mylocation"></div>',title:{text:b,button:"Close"}},position:{my:"bottom center",at:"up center"},hide:!1,style:{classes:"draggable-tooltip qtip-shadow qtip-"+f},events:{show:function(n){var t=$(n.currentTarget).find(".map_mylocation");setTimeout(function(){$(n.currentTarget).geocomplete({map:t,location:b})},0)},render:function(n,t){$(this).draggable({containment:"window",handle:t.elements.titlebar})}}})},hide:function(n){$(n.currentTarget).show(),$(n.currentTarget).removeClass(i).addClass(r).fadeOut(1e3)},render:function(n,t){$(this).draggable({containment:"window",handle:t.elements.titlebar})}}})})},hide:function(n){$(n.currentTarget).show(),$(n.currentTarget).removeClass(i).addClass(r).fadeOut(1e3)},render:function(n,t){$(this).draggable({containment:"window",handle:t.elements.titlebar})}}})})}(function(n){n.fn.RegalCalendar=function(t){var i=n.extend({base:"white",theme:"cyan",enter:"fadeInUp",exit:"fadeOutDown",animation:"fadeInUp",show:"click",modal:!1,startWeek:1,tooltipPosition:"right",tooltip:"bootstrap",defaultDate:null,mnDate:null,mxDate:null,timeFormat:"hrs",mapLink:"",inputDate:!1,inputEvent:!1,inputLocation:!1,twitter:!1,responsive:!1,url:"php/twitter.php"},t),r=n(this),o=r.find("table.ui-datepicker-calendar"),u=r.find("span.event"),f,e;r.addClass(i.theme+" "+i.base),r.css({position:"relative"});r.on("mouseenter","a.ui-datepicker-next",function(){r.data("dir","Next")});r.on("mouseenter","a.ui-datepicker-prev",function(){r.data("dir","Prev")});if(calendar=r.datepicker({defaultDate:i.defaultDate,minDate:i.mnDate,maxDate:i.mxDate,dateFormat:"dd/mm/yy",dayNamesMin:["SUN","MON","TUE","WED","THU","FRI","SAT"],firstDay:i.startWeek,hideIfNoPrevNext:!0,showOtherMonths:!0,onSelect:function(t,u){var f;u.inline=!1,n(this).find(".ui-datepicker-calendar .ui-datepicker-current-day").removeClass("ui-datepicker-current-day").children().removeClass("ui-state-active"),n(this).find(".ui-datepicker-calendar tbody a").each(function(){n(this).text()==u.selectedDay&&(n(this).addClass("ui-state-active"),n(this).parent().addClass("ui-datepicker-current-day"))}),i.inputDate&&n(i.inputDate).val(t),i.inputEvent&&(f=r.find("td a:containsNumber("+u.selectedDay+")"),n(i.inputEvent).val(f.data("title"))),i.inputLocation&&(f=r.find("td a:containsNumber("+u.selectedDay+")"),n(i.inputLocation).val(f.data("location")))},onChangeMonthYear:function(){setTimeout(function(){if(setEvents(u,r,i.theme),setTooltip(u,r,i.enter,i.exit,i.theme,i.tooltip,i.twitter,i.tooltipPosition,i.show,i.timeFormat,i.mapLink),i.animation){var n=i.animation.indexOf("rc")>=0?r.data("dir"):"";window.navigator.appName!="Microsoft Internet Explorer"?r.find("table.ui-datepicker-calendar, div.ui-datepicker-title").addClass(i.animation+n+" animate"):r.find("table.ui-datepicker-calendar").css({opacity:1}).animate({opacity:1},{duration:2300,easing:"linear"})}i.responsive&&adjust(r)},0)}}),r.prepend('<span class="regal-prevyear_gray"></span><span class="regal-nextyear_gray"></span>'),setEvents(u,r,i.theme),setTooltip(u,r,i.enter,i.exit,i.theme,i.tooltip,i.twitter,i.tooltipPosition,i.show,i.timeFormat,i.mapLink),r.find(".regal-prevyear_gray").click(function(){n.datepicker._adjustDate(r,-1,"Y")}),r.find(".regal-nextyear_gray").click(function(){n.datepicker._adjustDate(r,1,"Y")}),f=r.find("table.ui-datepicker-calendar tr th").css("border-bottom-color"),i.modal){r.addClass("modal-calendar"),n("body").append('<div class="modal-bg" style="background:'+f+'"></div><div class="modal-wrapper"></div><div class="modal_switch modal_'+i.theme+'"></div>'),r.appendTo("div.modal-wrapper"),n("div.modal-wrapper").center();n("body").on("click","div.modal_switch",function(){n(this).data("on")?(n(".modal-bg,div.modal-wrapper").fadeOut(1e3),n(this).data("on",!1)):(n(".modal-bg,div.modal-wrapper").fadeIn(1e3),n(this).data("on",!0))})}i.twitter&&(r.append('<span class="twitter_search">'+i.twitter+"</span>"),e=r.find(".twitter_search").twitterpopup({colorExterior:f,modal:i.modal,container:r,url:i.url}),i.modal&&e.css("color","#FFF")),i.responsive&&(adjust(r),n(window).resize(function(){adjust(r)}))}})(jQuery),function(n){n.fn.extend({center:function(t){var t=n.extend({inside:window,transition:0,minX:0,minY:0,withScrolling:!1,vertical:!0,horizontal:!0},t);return this.each(function(){var u={position:"fixed"},r,i;return t.vertical&&(r=(n(t.inside).height()-n(this).outerHeight())/2,t.withScrolling&&(r+=n(t.inside).scrollTop()||0),r=r>t.minY?r:t.minY,n.extend(u,{top:r+"px"})),t.horizontal&&(i=(n(t.inside).width()-n(this).outerWidth())/2,t.withScrolling&&(i+=n(t.inside).scrollLeft()||0),i=i>t.minX?i:t.minX,n.extend(u,{left:i+"px"})),t.transition>0?n(this).animate(u,t.transition):n(this).css(u),n(this)})}})}(jQuery),$.extend($.expr[":"],{containsNumber:function(n,t,i){var r=$(n).text();return parseInt(r)==parseInt(i[3])}});
 ...
 */
 ...
 (function(n){function t(n){var u=new Date((n||"").replace(/-/g,"/").replace(/TZ/g," ")),i=(+new Date-u.getTime())/1e3,t=Math.floor(i/86400),r;if(!isNaN(t)&&!(t<0)&&!(t>=31))return r=t==0&&(i<60&&"just now"||i<120&&"1 minute ago"||i<3600&&Math.floor(i/60)+" minutes ago"||i<7200&&"1 hour ago"||i<86400&&Math.floor(i/3600)+" hours ago")||t==1&&"Yesterday"||t<7&&t+" days ago"||t<31&&Math.ceil(t/7)+" weeks ago",r||window.console&&console.log(n),r?r:""}n.fn.twitterSearch=function(t){return typeof t=="string"&&(t={term:t}),this.each(function(){function h(t){var u=n('<div class="twitterSearchFail">'+t+"</div>").css(i.css.fail);r.empty().append(u)}function s(){if(e.twitterSearchPause){setTimeout(s,500);return}var n=r.children(":first"),t=n[0];n.animate(i.animOut,i.animOutSpeed,function(){var u=n.outerHeight();n.animate({marginTop:-u},i.animInSpeed,function(){n.css({marginTop:0,opacity:1});/*@cc_on try{t.style.removeAttribute("filter")}catch(u){}@*/n.css(i.css.tweet).show().appendTo(r)}),setTimeout(s,i.timeout)})}var u=n(this),i=n.extend(!0,{},n.fn.twitterSearch.defaults,t||{},n.metadata?u.metadata():{}),v,a,c,o,f,l,y;if(i.formatter=i.formatter||n.fn.twitterSearch.formatter,i.filter=i.filter||n.fn.twitterSearch.filter,v=i.url+i.term,!i.applyStyles)for(a in i.css)i.css[a]={};i.title===null&&(i.title=i.term),i.title=i.title||"",c=i.titleLink?'<a href="'+i.titleLink+'">'+i.title+"</a>":"<span>"+i.title+"</span>",o=n(c),i.titleLink&&o.css(i.css.titleLink),f=n('<div class="twitterSearchTitle"></div>').append(o).appendTo(u).css(i.css.title),i.bird&&(l=n('<img class="twitterSearchBird" src="'+i.birdSrc+'" />').appendTo(f).css(i.css.bird),i.birdLink&&l.wrap('<a href="'+i.birdLink+'"></a>'));var r=n('<div class="twitterSearchContainter"></div>').appendTo(u).css(i.css.container),p=n('<div class="twitterSearchClose"></div>').appendTo(u),e=r[0];i.colorExterior&&f.css("background-color",i.colorExterior),i.colorInterior&&r.css("background-color",i.colorInterior),u.css(i.css.frame),i.colorExterior&&u.css("border-color",i.colorExterior),y=u.innerHeight()-f.outerHeight(),i.pause&&r.hover(function(){e.twitterSearchPause=!0},function(){e.twitterSearchPause=!1}),n('<div class="twitterSearchLoading">Loading tweets..</div>').css(i.css.loading).appendTo(r),n.ajax({url:i.url,timeout:3e4,dataType:"json"}).fail(function(n,t,i){h(i)}).done(function(t){if(t.error){h(t.error);return}(r.empty(),n.each(t.statuses,function(){var o,u,s,f,e;i.filter.call(i,this)&&(o=i.formatter(this,i),u=n(o),u.css(i.css.tweet),s=u.find(".twitterSearchProfileImg").css(i.css.img),u.find(".twitterSearchUser").css(i.css.user),u.find(".twitterSearchTime").css(i.css.time),u.find("a").css(i.css.a),u.appendTo(r),f=u.find(".twitterSearchText").css(i.css.text),i.avatar&&(e=s.outerWidth()+parseInt(u.css("paddingLeft")),f.css("paddingLeft",e)))}),t.statuses.length<2)||setTimeout(s,i.timeout)})})},n.fn.twitterSearch.filter=function(){return!0},n.fn.twitterSearch.formatter=function(n,i){var u=n.text,r,f;return i.anchors&&(u=n.text.replace(/(http:\/\/\S+)/g,'<a target="_blank" href="$1">$1</a>'),u=u.replace(/\@(\w+)/g,'<a style="color:'+i.colorExterior+'" target="_blank" href="http://twitter.com/$1">@$1</a>')),r='<div class="twitterSearchTweet">',i.avatar&&(r+='<img class="twitterSearchProfileImg" src="'+n.user.profile_image_url+'" />'),r+='<div><span class="twitterSearchUser"><a style="color:'+i.colorExterior+'" target="_blank" href="https://twitter.com/search/realtime?q='+n.user.screen_name+'">'+n.user.name+" @"+n.user.screen_name+"</a></span>",f=t(n.created_at),i.time&&f&&(r+=' <span class="twitterSearchTime">('+f+")</span>"),r+='<div class="twitterSearchText">'+u+"</div></div></div>"},n.fn.twitterSearch.defaults={url:"http://search.twitter.com/search.json?callback=?&q=",anchors:!0,animOutSpeed:700,animInSpeed:700,animOut:{opacity:0},applyStyles:!0,avatar:!0,bird:!0,birdLink:!1,birdSrc:"http://cloud.github.com/downloads/malsup/twitter/tweet.gif",colorExterior:null,colorInterior:null,filter:null,formatter:null,pause:!1,term:"",time:!0,timeout:8e3,title:null,titleLink:null,css:{a:{textDecoration:"none"},bird:{width:"50px",height:"20px",position:"absolute",left:"-30px",top:"-20px",border:"none"},container:{overflow:"hidden",backgroundColor:"#FFF",height:"253px",border:"1px solid #ccc"},fail:{background:"#6cc5c3 url(http://cloud.github.com/downloads/malsup/twitter/failwhale.png) no-repeat 50% 50%",height:"100%",padding:"10px"},frame:{height:"280px",border:"5px solid #C2CFF1","-moz-box-shadow":"1px 1px 5px #000","-webkit-box-shadow":"1px 1px 5px #000"},tweet:{padding:"5px 10px",clear:"left"},img:{float:"left",margin:"5px 10px 5px 0px",width:"48px",height:"48px","-moz-box-shadow":"1px 1px 5px #000","-webkit-box-shadow":"1px 1px 5px #000"},loading:{padding:"20px",textAlign:"center",color:"#888",fontSize:"10px"},text:{fontSize:"11px",borderBottom:"1px solid #ddd",paddingBottom:"6px"},time:{fontSize:"10px",color:"#888"},title:{},titleLink:{textDecoration:"none"},user:{fontWeight:"bold",fontSize:"11px",textShadow:"1px 1px 1px #fff"}}}})(jQuery),function(n,t){t.fn.twitterpopup=function(n){var i=t.extend({},t.fn.twitterpopup.defaults,n);return this.each(function(){var n=t(this),r=t.meta?t.extend({},i,n.data()):i;n.bind("click",function(){var u=t(this),r,f;u.data("active")||(r=t('<div class="search_results"></div>').appendTo(i.container),r.twitterSearch({term:u.html(),bird:!1,colorExterior:i.colorExterior,colorInterior:"#FFF",pause:!0,timeout:3e3,url:i.url}),f=t.fn.twitterpopup.calculatePopupPositions(u,r),r.resizable({alsoResize:r.find(".twitterSearchContainter"),handles:"se"}).draggable(),r.css({left:0,top:"82px"}).show(),u.data("active",!0),r.find(".twitterSearchClose").bind("click",function(){r.remove(),u.data("active",!1)}))})})},t.fn.twitterpopup.getWindowSize=function(){return{width:n.width(),height:n.height()}},t.fn.twitterpopup.calculatePopupPositions=function(i,r){var s=t.fn.twitterpopup.getWindowSize(),o=i.offset().left+i.width()+20,e=i.offset().top,l=r.width(),u,f,c,h;return o+l>s.width&&(o=i.offset().left-l-20),u=i.offset().top-n.scrollTop(),f=r.height(),u<0?e=i.offset().top-u:u+f>s.height&&(c=u+f-s.height,e=i.offset().top-c-20),h={left:o,top:e}}}(jQuery(window),jQuery);
