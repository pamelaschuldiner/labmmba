...
<html>
    ...
    <body>
        ...
        <div id="show-field" class="content scaffold-show" role="main">
            ...
            <f:display bean="field" />
            <g:form resource="${this.field}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.field}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
