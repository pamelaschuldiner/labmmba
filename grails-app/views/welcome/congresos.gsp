    ...
    <div class="container">   
        <div class="row">
            <div class="side-left col-sm-4 col-md-4">
                ...
                <g:form action="create_and_upload" controller="event" enctype="multipart/form-data" method="post">
                    <table>
                        <tr><p>
                          <td align="left">*Nombre congreso:     </td>
                          <td align="left"><g:textField name="event_name" class="others" size="40" required="true"/></td>
                        </tr></p>
                        <tr><p>
                          <td align="left">*Fechas:     </td>
                          <td align="left">
                              Desde  <div class="others"> <g:datePicker name="event_datei" precision="day" noSelection="['':'-Choose-']" relativeYears="[-50..0]"/> </div>
                              Hasta  <div class="others"> <g:datePicker name="event_datef" precision="day" noSelection="['':'-Choose-']" relativeYears="[-50..0]"/>    </div>
                          </td>
                        </tr></p>
                        <tr><p>
                          <td align="left">*Ciudad:     </td>
                          <td align="left"><g:textField name="event_city" class="others" size="40" required="true"/></td>
                        </tr></p>
                        <tr><p>
                            <td align="left">*País:     </td>
                            <td align="left"><g:countrySelect name="event_count" class="others" required="true"/></td>
                        </tr></p>
                        <tr><p>
                          <td align="left">Nombre presentación:     </td>
                          <td align="left"><g:textField name="event_pname" class="others" size="40" required="true"/></td>
                        </tr></p>
                        <tr><p>
                          <td align="left">PDF presentación:     </td>
                          <td align="left"><input type="file" name="presentacion" size="40" accept="application/pdf"></td>
                        </tr></p>
                    </table>
                    <p></p>
                    <g:actionSubmitImage value="create_and_upload" src="${resource(dir: 'assets/images', file: 'agregar.png')}"/>
                </g:form>
                (*) Campos obligatorios
                </ul>
            </div>
