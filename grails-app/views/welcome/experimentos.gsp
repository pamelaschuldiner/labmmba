...
<html lang="en">
    ...
    <div class="container">   
        <div class="row">
            ...
            <div class="col-sm-8 col-md-8">
               <div id='cssmenu'>
                    <ul>
                        <li><g:link controller="welcome" action="#">Resumen de Perfil</g:link></li>
  ...
  <script>
        function addName(){
            int counter=0;
            document.getElementById("file").download = {$springSecurityService.currentUser.id} + document.getElementById("exp_name") + "_" + counter + ".jpg";
            counter=counter+1;
        }
</script>
</html>
