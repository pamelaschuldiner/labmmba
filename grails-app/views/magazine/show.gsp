...
<html>
    ...
    <body>
        ...
        <div id="show-magazine" class="content scaffold-show" role="main">
            ...
            <f:display bean="magazine" />
            <g:form resource="${this.magazine}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.magazine}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
